...
type Repo interface {
	...
	EnrollUserByInvite(ctx context.Context, userID uuid.UUID, invite *Invite) error
	GetCourseMember(ctx context.Context, userID, courseID uuid.UUID) (*CourseMember, error)
}
